            ...
            modelBuilder.Entity("Domain.Models.SystemParameter", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationTime = new DateTime(2024, 7, 26, 23, 3, 2, 336, DateTimeKind.Local).AddTicks(4844),
                            Description = "Roles"
                        },
                        new
                        {
                            Id = 2L,
                            CreationTime = new DateTime(2024, 7, 26, 23, 3, 2, 336, DateTimeKind.Local).AddTicks(4855),
                            Description = "Ciclos"
                        },
                        new
                        {
                            Id = 3L,
                            CreationTime = new DateTime(2024, 7, 26, 23, 3, 2, 336, DateTimeKind.Local).AddTicks(4856),
                            Description = "Matriculas"
                        },
                        new
                        {
                            Id = 4L,
                            CreationTime = new DateTime(2024, 7, 26, 23, 3, 2, 336, DateTimeKind.Local).AddTicks(4857),
                            Description = "Porcentaje Calificaciones"
                        },
                        new
                        {
                            Id = 5L,
                            CreationTime = new DateTime(2024, 7, 26, 23, 3, 2, 336, DateTimeKind.Local).AddTicks(4858),
                            Description = "Tipo Calificaciones"
                        },
                        new
                        {
                            Id = 6L,
                            CreationTime = new DateTime(2024, 7, 26, 23, 3, 2, 336, DateTimeKind.Local).AddTicks(4859),
