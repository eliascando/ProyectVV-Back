            ...
            modelBuilder.Entity("Domain.Models.SystemParameter", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationTime = new DateTime(2024, 8, 10, 17, 58, 2, 312, DateTimeKind.Local).AddTicks(7740),
                            Description = "Roles"
                        },
                        new
                        {
                            Id = 2L,
                            CreationTime = new DateTime(2024, 8, 10, 17, 58, 2, 312, DateTimeKind.Local).AddTicks(7755),
                            Description = "Ciclos"
                        },
                        new
                        {
                            Id = 3L,
                            CreationTime = new DateTime(2024, 8, 10, 17, 58, 2, 312, DateTimeKind.Local).AddTicks(7757),
                            Description = "Matriculas"
                        },
                        new
                        {
                            Id = 4L,
                            CreationTime = new DateTime(2024, 8, 10, 17, 58, 2, 312, DateTimeKind.Local).AddTicks(7758),
                            Description = "Porcentaje Calificaciones"
                        },
                        new
                        {
                            Id = 5L,
                            CreationTime = new DateTime(2024, 8, 10, 17, 58, 2, 312, DateTimeKind.Local).AddTicks(7759),
                            Description = "Tipo Calificaciones"
                        },
                        new
                        {
                            Id = 6L,
                            CreationTime = new DateTime(2024, 8, 10, 17, 58, 2, 312, DateTimeKind.Local).AddTicks(7760),
