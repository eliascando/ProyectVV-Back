            ...
            modelBuilder.Entity("Domain.Models.SystemParameter", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationTime = new DateTime(2024, 7, 26, 22, 37, 12, 477, DateTimeKind.Local).AddTicks(4719),
                            Description = "Roles"
                        },
                        new
                        {
                            Id = 2L,
                            CreationTime = new DateTime(2024, 7, 26, 22, 37, 12, 477, DateTimeKind.Local).AddTicks(4734),
                            Description = "Ciclos"
                        },
                        new
                        {
                            Id = 3L,
                            CreationTime = new DateTime(2024, 7, 26, 22, 37, 12, 477, DateTimeKind.Local).AddTicks(4736),
                            Description = "Matriculas"
                        },
                        new
                        {
                            Id = 4L,
                            CreationTime = new DateTime(2024, 7, 26, 22, 37, 12, 477, DateTimeKind.Local).AddTicks(4737),
                            Description = "Porcentaje Calificaciones"
                        },
                        new
                        {
                            Id = 5L,
                            CreationTime = new DateTime(2024, 7, 26, 22, 37, 12, 477, DateTimeKind.Local).AddTicks(4739),
                            Description = "Tipo Calificaciones"
                        },
                        new
                        {
                            Id = 6L,
                            CreationTime = new DateTime(2024, 7, 26, 22, 37, 12, 477, DateTimeKind.Local).AddTicks(4740),
